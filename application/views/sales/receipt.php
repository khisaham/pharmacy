...
<div id="receipt_wrapper">
	<div id="receipt_header">
		...
		?>
		<div id="company_address"><?php echo nl2br($this->config->item('name')); ?></div>
...
<tr>
	<td>&nbsp;</td>
	<td>Pin:<?php echo nl2br($this->config->item('pin')); ?></td>
</tr>
<tr>
	<td>&nbsp;</td>
	<td>M-Pesa Till#:<?php echo nl2br($this->config->item('till_no')); ?></td>
</tr>
	</table>
<div id="sale_return_policy">
	...
	<div id='barcode'>
		<center>Thank you for shoping with us @</br> Leymosek Agencies Limited</br> Welcome again</center>
	</div>
<div id='barcode'>
		<center><h6>Powered by Appex Software Ltd</h6></center>
	</div>
