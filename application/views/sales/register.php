...
<?php //echo $this->lang->line('sales_register'); ?>
	<h6>St. Gabriel Hospital Ltd <span></span></h6>
</div>
...
<div id="register_wrapper">
	...
	<span><?php echo $this->lang->line('sales_type_mode') ?></span>
			...
			?>
					<tr>
						...
						<?php if ($items_module_allowed)
						{
							...
							// if($mode == 'sale'){
							// 	$price_value = $item['retprice'];
							// }
							
						?>
							<td><?php echo form_input(array('name'=>'price','value'=>$price_value,'size'=>'6', 'readonly'=>'true'));?></td>
						<?php
						}
						else
						{
						?>
							<td><?php echo to_currency($price_value); ?></td>
							<?php echo form_hidden('price',$price_value); ?>
						<?php
						}
						?>
						...
						<td><?php echo to_currency($price_value*$item['quantity']-$price_value*$item['quantity']*$item['discount']/100); ?></td>
			...
			<div>
				...
				<table width="100%">
					...
					<tr>
						...
						<td>
							<?php echo form_input( array( 'name'=>'amount_tendered', 'id'=>'amount_tendered','value'=>to_currency(0), 'size'=>'10','tabindex'=>4)); ?>
						</td>
					</tr>
				</table>
