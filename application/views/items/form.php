...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_expiry').':', 'expiry',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'expiry',
		'id'=>'expiry',
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_form').':', 'form',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_dropdown('form', $form);?>
	</div>
</div>
...
<div class="field_row clearfix">
<?php echo form_label($this->lang->line('items_wholesale_price').':', 'wholesale_price',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'wholesale_price',
		'size'=>'8',
		'id'=>'wholesale_price',
		'value'=>$item_info->wholesale_price)
	);?>
	</div>
</div>
