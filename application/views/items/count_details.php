...
<td>    
    <?php $cat = array (
        ...
        'name'=>'category',
        'id'=>'category',
        'value'=>$this->db->get_where('pharm_aceticsclass', array('pharmaceticsClass_id'=>$item_info->category))->row()->pharmaceticsClass_name,
        'style'       => 'border:none',
        'readonly' => 'readonly'
        );
...
<tr>
<td>    
<?php echo form_label($this->lang->line('items_form').':', 'form',array('class'=>'wide')); ?>
</td>
<td>    
    <?php $cat = array (
...
<tr>
<td>    
<?php echo form_label($this->lang->line('items_expiry').':', 'expiry',array('class'=>'wide')); ?>
</td>
<td>    
    <?php $expiry = array (
