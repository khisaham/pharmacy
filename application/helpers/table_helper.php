...
function get_items_manage_table($items,$controller)
{
	...
	//$CI->lang->line('items_wholesale_price'),
	$CI->lang->line('items_unit_price'),
	$CI->lang->line('items_quantity'),
	$CI->lang->line('items_expiry'),
	'&nbsp;',
	'&nbsp;',
	'&nbsp;'	
	);
...
function get_item_data_row($item,$controller)
{
	...
	$table_data_row.='<td width="14%">'.$CI->Item_taxes->get_category_name($item->category).'</td>';
	
	$table_data_row.='<td width="14%">'.to_currency($item->cost_price).'</td>';
	//$table_data_row.='<td width="14%">'.$item->wholesale_price.'</td>';
	$table_data_row.='<td width="14%">'.to_currency($item->retail_price).'</td>';
    $table_data_row.='<td width="14%">'.$item->quantity.'</td>';
	$table_data_row.='<td width="14%">'.$item->expiry.'</td>';
	$image = '';
